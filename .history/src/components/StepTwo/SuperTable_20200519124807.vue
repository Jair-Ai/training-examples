...
export default {
  ...
  mounted() {
    ...
    if (this.incorrects.lenght == 0 && this.duplicates.lenght == 0) {
      var colorRow = "success";
    } else if (this.duplicates > 0) {
      var colorRow = "warning";
    } else {
      var colorRow = "danger";
    }

    this.fields[0].variant = colorRow;
    this.fields[1].variant = colorRow;
    this.fields[2].variant = colorRow;
  },
  methods: {
    editedRow(e, item) {
